...
public class RangedAttackState : AttackState {
    ...
    public RangedAttackState(EnemyController enemyController) : base(enemyController)
    {
    ...
    public void Attack()
    {
        ...
        if (currentTime > controller.attackCooldown)
        {
            ...
            EnemyRangedController rangedController = controller as EnemyRangedController;
